			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a class="site_title"><i class="fa fa-home"></i> <span>S&M
								Employee Manager</span></a>
					</div>
					...
					<div class="profile clearfix">
						<div class="profile_pic">
							<img src="resources/images/111.jpeg" alt="..."
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							<ul class="nav side-menu">
								...
								<li id="nexusApp"><a><i class="fa fa-server"></i>Nexus
										App<span class="fa fa-chevron-down"></span></a>
								...
								<li id="nexusAppAdmin"><a><i class="fa fa-server"></i>NexusAppAdmin<span
