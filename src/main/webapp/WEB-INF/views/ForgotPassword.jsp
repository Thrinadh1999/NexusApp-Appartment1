	...
	<div class="cover">
    	...
    	<div class="col-md-4 col-sm-6 col-xs-12">        
       		...
       		<div class="col-md-10 col-sm-10 col-xs-10">
       			...
       			<form:form class="form-horizontal" action="resetPassword" method="post" modelAttribute="newPassword">
					...
					<div style="border:1px solid #fff; padding:15px;">
						<div class="form-group">
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								<form:input type="text" class="form-control" path="username" placeholder="Please Enter your email address" required="required"/>
							</div>
						...
						<div class="form-group" style="text-align:center;">
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								<input style="width:100%;background:#398439;color:#fff;" class="btn" type="submit" value="Forgot Password" />
							</div>						
						</div>					
					</div>
    	...
    	<div class="clearfix"></div>
      	<div style="height:100px;margin-top:10px;">
			<p style="text-align:center;margin-top:30px;">By using this application, you agree to our <a href="terms" target="_blank">Terms of Usage</a> and accept our <a href="privacy" target="_blank">Privacy Policy</a>.</p>
		</div>    
		<br/><br/> 
		<div class="clearfix"></div>
