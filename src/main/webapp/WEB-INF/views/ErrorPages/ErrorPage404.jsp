...
<body>
    <div class="cover">
        ...
        <h1>Oops!</h1>        
        <p class="lead">We could not find what you are looking for.</p>
        <p>Please go back to the previous page and try again. </p>
        <p>If the issue still persists, please send an email to support@pranavaeet.com and our support team will get back to you.</p>
    	<p class="lead">Error Code: 404</p>
    </div>
