...
<body>
    <div class="cover">
        ...
        <p class="lead">Did you fill all the details?</p> 
        <p>Please go back to the previous page and make sure you filled all the required details.</p>       
        <p>If you still face the same issue, please send an email to support@pranavaeet.com and our support team will get back to you.</p>
    	<p class="lead">Error Code: 400</p>
    </div>
