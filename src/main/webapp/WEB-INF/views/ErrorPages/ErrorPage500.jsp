...
<body>
    <div class="cover">
    	<img src="resources/images/logo.png" alt="Pranava EET"/>
        <h1>Well, that was unexpected :(</h1>        
        <p class="lead">Looks like something is wrong with our servers.</p>
        <p>We've notified our Engineering Team about this and they will be fixing it shortly.</p>
        <p>If you need immediate assistance, please send an email to support@pranavaeet.com and our support team will get back to you.</p>
    	<p class="lead">Error Code: 500</p>
    </div>
